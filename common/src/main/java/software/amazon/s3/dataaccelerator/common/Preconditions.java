...
/*
 * This code is based on https://github.com/google/guava/blob/master/guava/src/com/google/common/base/Preconditions.java
 ...
 *
 * <p>{@code Preconditions} only support the {@code "%s"} specifier, not the full range of {@link
...
public final class Preconditions {
   ...
   */
  public static void checkArgument(
      boolean expression, String errorMessageTemplate, Object p1, Object p2) {
    if (!expression) {
      throw new IllegalArgumentException(lenientFormat(errorMessageTemplate, p1, p2));
    }
  }
   ...
   */
  public static <T> T checkNotNull(
      T reference, String errorMessageTemplate, Object p1, Object p2, Object p3) {
    if (reference == null) {
   ...
   */
  public static <T> T checkNotNull(
      T reference, String errorMessageTemplate, Object p1, Object p2, Object p3, Object p4) {
    if (reference == null) {
