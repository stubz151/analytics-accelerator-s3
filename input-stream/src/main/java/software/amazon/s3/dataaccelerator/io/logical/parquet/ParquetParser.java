...
import static software.amazon.s3.dataaccelerator.util.Constants.PARQUET_FOOTER_LENGTH_SIZE;
import static software.amazon.s3.dataaccelerator.util.Constants.PARQUET_MAGIC_STR_LENGTH;
